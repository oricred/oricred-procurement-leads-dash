...
export default function App() {
  ...
  return <Routes><Route path="/login" element={<LoginPage />} /><Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
    ...
    <Route path="discover" element={<DiscoverPage />} /><Route path="leads" element={<LeadsPage />} /><Route path="pipeline" element={<PipelinePage />} />
    <Route path="matching" element={<Navigate to="/discover?tab=tenders" replace />} /><Route path="awards" element={<Navigate to="/discover?tab=awards" replace />} />
