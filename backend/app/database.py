...
def _engine_kwargs() -> dict:
    """Pool settings, for the backends that have a pool.

    SQLite does not use a queue pool, and passing pool_size to it raises. Every
    deployed environment is PostgreSQL, so the sizing below is what matters in
    practice; see Settings.db_pool_size for why the defaults were raised.
    """
